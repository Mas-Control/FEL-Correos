...
#                         logger.info(
#                             f"Factura procesada exitosamente: {factura.serie}-{factura.numero}"
#                         )
...
#     nit: str, fecha_inicio: Optional[str] = None, fecha_fin: Optional[str] = None
# ) -> ClienteResumen:
...
#                     if filename.startswith(f"{serie}_{numero}_") and filename.endswith(
#                         ".json"
#                     ):
